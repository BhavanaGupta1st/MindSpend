    ...
    return (
        <div className="flex flex-col items-center justify-center min-h-screen bg-gray-900 text-white">
            <div className="text-center p-8 max-w-md mx-auto">
                ...
                <h1 className="text-5xl font-bold mb-4">Welcome to MindSpend AI</h1>
                <p className="text-lg text-gray-400 mb-8">
                    Your personal AI companion for mindful spending and financial wellness.
                </p>
                <button
                    onClick={login}
                    className="w-full bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-3 px-6 rounded-lg text-lg transition duration-300 ease-in-out flex items-center justify-center shadow-lg"
                >
